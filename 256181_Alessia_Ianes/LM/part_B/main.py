...
if __name__ == "__main__":
    ...
    trigger_patience = 3  # Number of epochs without improvement to trigger ASGD
    use_asgd = False  # Flag to indicate if ASGD is active
        ...
        for emb in emb_size:
            for hid in hid_size:
                for lr in lr_values:
                    ...
                    model = LM_LSTM_wt_vd(emb, hid, vocab_len, pad_index=lang.word2id["<pad>"]).to(DEVICE)
                ...
                #If the PPL is too high try to change the learning rate
                    for epoch in pbar:
                        ...
                        if epoch % 1 == 0:
                            ...
                            if  ppl_dev < best_ppl: # the lower, the better
                                ...
                                patience -= 1
                                trigger_counter += 1  # Increment trigger counter
                    ...
                    csv_filename = f'results/LSTM_weight_tying/LSTM_ppl_results_lr_{lr}_bs_{bs}_emb_{emb}_hid_{hid}.csv'
                    ...
                    # Save ppl_dev plot
                    ppl_plot_filename = f'results/LSTM_weight_tying/plots/LSTM_ppl_plot_lr_{lr}_bs_{bs}_emb_{emb}_hid_{hid}.png'
                    ...
                    # Save loss plot
                    loss_plot_filename = f'results/LSTM_weight_tying/plots/LSTM_loss_plot_lr_{lr}_bs_{bs}_emb_{emb}_hid_{hid}.png'
